    ...
    <div className="space-y-6">
      ...
      <div className="border rounded-lg p-4">
        ...
        <div className="space-y-3">
          ...
          <button
            onClick={() => runTask(
              'Sentiment Analysis',
              () => runAnalyzeSentiment(sentimentText),
              { text: sentimentText }
            )}
      ...
      <div className="border rounded-lg p-4">
        ...
        <div className="space-y-3">
          ...
          <button
            onClick={() => runTask(
              'Translate Text',
              () => runTranslate(translateText, targetLanguage),
      ...
      <div className="border rounded-lg p-4">
        ...
        <div className="space-y-3">
          ...
          <button
            onClick={() => runTask(
              'Summarize Text',
              () => runSummarize(summarizeText, parseInt(maxSentences)),
      ...
      <div className="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
        <p className="text-sm text-green-800">
          OpenAI-powered tasks can run concurrently. Check the sidebar to track progress.
        </p>
      </div>
    </div>
  )
